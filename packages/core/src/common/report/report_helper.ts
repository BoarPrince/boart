...
export class StepReportHelper {
    ...
    private readonly _startTime: string;
    private readonly _descriptions = new Array<string>();
    private readonly _result = new Map<string, string | ReadonlyArray<any>>();
    private readonly _input = new Map<string, string | ReadonlyArray<any>>();
    private readonly stepContext: any;
