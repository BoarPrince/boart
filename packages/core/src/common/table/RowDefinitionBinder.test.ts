 ...
 *
 */
describe('check Row Definition Binder', () => {
    /**
     *
     */
    ...
    describe('check binding', () => {
         ...
         */
        it.each([
            ['1.', 'a:a', ParaType.False, 'a:a', 'a:a', null],
            ['2.', 'a:a', ParaType.Optional, 'a:a', 'a:a', null],
            ['3.', 'a:a', ParaType.Optional, 'a:a:para', 'a:a', 'para'],
            ['4.', 'a-a', ParaType.Optional, 'a-a:para', 'a-a', 'para'],
            ['5.', 'a:a', ParaType.True, 'a:a:para', 'a:a', 'para'],
            ['6.', 'a:a', ParaType.True, 'a:a:para:1', 'a:a', 'para:1'],
            ['7.', 'a:a', ParaType.Optional, 'a:a:para:1', 'a:a', 'para:1']
        ])(
            `%s: check key and para (defKey: '%s', paraType: '%p', key: '%s', expected key: '%s', expected para: '%s'`,
            (_: string, defKey: string, paraType: ParaType, rowKey: string, expectedKey: string, expectedPara: string) => {
                const rowDefinitions = [
                    new RowDefinition({
                        key: Symbol(defKey),
