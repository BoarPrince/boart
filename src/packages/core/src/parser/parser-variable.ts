...
* INPUT GRAMMAR:
* start := '\$\{\s*' variable=SelectorToken selector=Selector? '\s*\}'
...
* SelectorSimple := selector=SelectorToken
* SelectorWithSimpleIndex := selector=SelectorToken '\s*\[\s*' index=IndexToken '\s*\]\s*'
* SelectorWithFirstIndex := selector=SelectorToken '\s*\[\s*:\s*' index=IndexToken '\s*\]\s*'
* SelectorWithEndIndex := selector=SelectorToken '\s*\[\s*-\s*' index=IndexToken '\s*:\s*\]\s*'
* SelectorWithStartEndIndex := selector=SelectorToken '\s*\[\s*' startIndex=IndexToken '\s*:\s*' endIndex=IndexToken? '\s*:\s*\]\s*'
* SelectorWithIndexList := selector=SelectorToken '\s*\[\s*' index=IndexToken list={'\s*,\s*' index=IndexToken }* '\s*\]\s*'
* SelectorWithWildcard := selector=SelectorToken '\s*\[\s*\*\s*\]\s*'
* SelectorWithWithRandomIndex := selector=SelectorToken '\s*\[\s*' count='[0-9]+'? '\s*\?\s*\]'
* //# -------------------------------------------------------
* //# Token
* //# -------------------------------------------------------
* SelectorToken := '[^#$\{\}:.+\[\] \t\n]+'
        ...
        return this.memoise(
            () => {
                return this.run<start>($$dpth,
                    () => {
                        let $scope$variable: Nullable<SelectorToken>;
                        let $scope$selector: Nullable<Nullable<Selector>>;
                        let $$res: Nullable<start> = null;
                        if (true
                            && this.regexAccept(String.raw`(?:\$\{\s*)`, $$dpth + 1, $$cr) !== null
                            && ($scope$variable = this.matchSelectorToken($$dpth + 1, $$cr)) !== null
                            && (($scope$selector = this.matchSelector($$dpth + 1, $$cr)) || true)
                            && this.regexAccept(String.raw`(?:\s*\})`, $$dpth + 1, $$cr) !== null
                        ) {
                            $$res = {kind: ASTKinds.start, variable: $scope$variable, selector: $scope$selector};
                        }
                        return $$res;
                    });
            },
        ...
        return this.memoise(
            () => {
                return this.run<SelectorSimple>($$dpth,
                    () => {
                        let $scope$selector: Nullable<SelectorToken>;
                        let $$res: Nullable<SelectorSimple> = null;
                        if (true
                            && ($scope$selector = this.matchSelectorToken($$dpth + 1, $$cr)) !== null
                        ) {
                            $$res = {kind: ASTKinds.SelectorSimple, selector: $scope$selector};
                        }
                        return $$res;
                    });
            },
                ...
                return this.run<SelectorWithSimpleIndex>($$dpth,
                    () => {
                        ...
                        if (true
                            ...
                            $$res = {kind: ASTKinds.SelectorWithSimpleIndex, selector: $scope$selector, index: $scope$index};
                        }
                        return $$res;
                    });
            },
                ...
                return this.run<SelectorWithFirstIndex>($$dpth,
                    () => {
                        ...
                        if (true
                            ...
                            $$res = {kind: ASTKinds.SelectorWithFirstIndex, selector: $scope$selector, index: $scope$index};
                        }
                        return $$res;
                    });
            },
                ...
                return this.run<SelectorWithEndIndex>($$dpth,
                    () => {
                        ...
                        if (true
                            ...
                            $$res = {kind: ASTKinds.SelectorWithEndIndex, selector: $scope$selector, index: $scope$index};
                        }
                        return $$res;
                    });
            },
                ...
                return this.run<SelectorWithStartEndIndex>($$dpth,
                    () => {
                        ...
                        if (true
                            ...
                            $$res = {kind: ASTKinds.SelectorWithStartEndIndex, selector: $scope$selector, startIndex: $scope$startIndex, endIndex: $scope$endIndex};
                        }
                        return $$res;
                    });
            },
                ...
                return this.run<SelectorWithIndexList>($$dpth,
                    () => {
                        ...
                        if (true
                            ...
                            $$res = {kind: ASTKinds.SelectorWithIndexList, selector: $scope$selector, index: $scope$index, list: $scope$list};
                        }
                        return $$res;
                    });
            },
                ...
                return this.run<SelectorWithWildcard>($$dpth,
                    () => {
                        ...
                        if (true
                            ...
                            $$res = {kind: ASTKinds.SelectorWithWildcard, selector: $scope$selector};
                        }
                        return $$res;
                    });
            },
                ...
                return this.run<SelectorWithWithRandomIndex>($$dpth,
                    () => {
                        ...
                        if (true
                            ...
                            $$res = {kind: ASTKinds.SelectorWithWithRandomIndex, selector: $scope$selector, count: $scope$count};
                        }
                        return $$res;
                    });
            },
