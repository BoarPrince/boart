...
describe('input-button-proxy', () => {
    ...
    test('must not be visible', async () => {
        await pageAdapter.driver.html('<input type="button" hidden id="test">test-button</input>');
        const element = await pageAdapter.element.byId('test');
    ...
    test('must be enabled', async () => {
        await pageAdapter.driver.html('<input type="button" id="test">test-button</input>');
        const element = await pageAdapter.element.byId('test');
    ...
    test('must not be enabled', async () => {
        await pageAdapter.driver.html('<input type="button" disabled id="test">test-button</input>');
        const element = await pageAdapter.element.byId('test');
    ...
    test('text must be available', async () => {
        await pageAdapter.driver.html('<input type="button" id="test" value="test-input-button-text"/>');
        const element = await pageAdapter.element.byId('test');
    ...
    test('classes must be visible', async () => {
        await pageAdapter.driver.html('<input type="button" id="test" class="test1  test2">test-button</input>');
        const element = await pageAdapter.element.byId('test');
    ...
    test('element must be locatable by text', async () => {
        await pageAdapter.driver.html('<input type="button" value="test-input-button"/>');
    ...
    test('element info must be accessible', async () => {
        await pageAdapter.driver.html(`<input type="button" id="test-id" class="clazz1 clazz2" value="test-input-button-value"/>`);
    ...
    test('click must work', async () => {
        await pageAdapter.driver.html(`
          <input type="button" id="test" onclick="clickHandler()"></input>
          <div id="test-2"></input>
